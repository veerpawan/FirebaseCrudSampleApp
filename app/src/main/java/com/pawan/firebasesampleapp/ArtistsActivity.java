...
public class ArtistsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_artists); Intent intent = getIntent();
         ...
         * */
        databaseTracks = FirebaseDatabase.getInstance().getReference("tracks").child(intent.getStringExtra(MainActivity2.ARTIST_ID));
        ...
        textViewArtist.setText(intent.getStringExtra(MainActivity2.ARTIST_NAME));
